...
struct SOAP_CMAC ns__GetInfo {
      public:
        /** Required element 'ConfigInfo' of XSD type 'xsd:string' */
        std::string ConfigInfo;
      public:
        /** Return unique type id SOAP_TYPE_ns__GetInfo */
        long soap_type() const { return SOAP_TYPE_ns__GetInfo; }
        /** Constructor with member initializations */
        ns__GetInfo() : ConfigInfo() { }
        /** Friend allocator */
